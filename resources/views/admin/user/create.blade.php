                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="disabledInput" placeholder="Petugas"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-end">
                                    <a href="{{ route('admin.user.index')}}" class="btn btn-light-secondary me-1 mb-1">Kembali</a>
